...
MEXP( cm_pe_resdir_t* ) cm_pe_load_resources( cm_pe_t pe )
{
	...
	{
		while( (uint16_t)( dir->subdir_count + dir->resource_count ) < dir->named_entry_count + dir->id_entry_count )
		{
...
MEXP( int ) cm_pe_fixed_version( cm_pe_t pe, cm_pe_res_t* res, cm_pe_version_t* ver )
{
	// find ".rsrc" section
