...
extern "C" {
	 ...
	 * Returns a nullptr pointer on failure.
	 */
	 ...
	 * password.  Returns the nls argument on success or a nullptr
	 * pointer on failure.
	 */
	 ...
	 * on success or a nullptr pointer on failure.
	 */
	 ...
	 */
	  ...
	  * password should use the returned value.  Returns a nullptr pointer on error.
	  */
